...
from latent_rationale.agnews.models.layperson import LinearLayperson
from latent_rationale.agnews.vocabulary import Vocabulary
from latent_rationale.agnews.models.model_helpers import build_model
from latent_rationale.agnews.util import get_predict_args, agnews_reader, \
...
from latent_rationale.agnews.evaluate import evaluate, evaluate_comm
...
def communicate():
    ...
    train_data = list(agnews_reader("data_spec/corpus/agnews/train.xml"))
    dev_data = list(agnews_reader("data_spec/corpus/agnews/dev.xml"))
    test_data = list(agnews_reader("data_spec/corpus/agnews/test.xml"))
